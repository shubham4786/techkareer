...
const page = () =>{
    ...
    return (
        <div className="flex justify-start ">
            ...
            <h1 className="text-5xl text-blue-400 mb-16">Welcome To Techkareer !</h1>
            <UserNameForm/>
            </div>
...
const UserNameForm = ( )=>{
  ...
  // 2. Define a submit handler.
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      const isJobseekr = values.role === "JobSeeker";
      const JobSeekerpathname = `/onboarding/jobseeker?name=${values.username}`
      const OrganizationPathName = `/onboarding/organization?name=${values.username}`

     
  
      router.push(isJobseekr ? JobSeekerpathname : OrganizationPathName);
    }
